...
| Conv2d Parameters (Pruning)      | 80% (1 - 20%)                         | Precisely reduced to 20% of their original sizes.                               |
| Conv2d FLOPs (Pruning)           | 44.6% (1 - 55.4%)                     | Reduction can far exceed 10%, due to zeroed weights.                            |
| **Validation Accuracy**                    |                           |                                                                                 |
